            ...
            <form action="{{ route('register.submit') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" required value="{{ old('name') }}"
                           class="w-full rounded-xl border-slate-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 text-sm py-2.5 px-3.5 @error('name') border-rose-500 @enderror"
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" required value="{{ old('email') }}"
                           class="w-full rounded-xl border-slate-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 text-sm py-2.5 px-3.5 @error('email') border-rose-500 @enderror"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input id="password" name="password" type="password" required
                               class="w-full rounded-xl border-slate-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 text-sm py-2.5 px-3.5 @error('password') border-rose-500 @enderror"
