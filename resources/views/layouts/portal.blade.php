    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="h-16 flex items-center justify-between px-6 border-b border-slate-800 bg-slate-950">
            <a href="{{ route('portal.dashboard') }}" class="flex items-center gap-3 group">
                <div class="w-10 h-10 rounded-xl bg-white p-1 flex items-center justify-center shadow-lg shadow-emerald-500/20 group-hover:scale-105 transition-transform shrink-0">
                    <img src="{{ asset('assets/CreTechlogopersegi.svg') }}" alt="CreTech Logo" class="w-full h-full object-contain">
                </div>
                <div>
                    <span class="text-lg font-bold text-white tracking-tight">Cre<span class="text-emerald-400">Tech</span></span>
