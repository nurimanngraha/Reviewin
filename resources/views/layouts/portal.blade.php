...
<div x-data="{ sidebarOpen: false }" class="h-screen bg-slate-100 flex overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="h-16 flex items-center justify-between px-4 border-b border-slate-800 bg-slate-950">
            <a href="{{ route('portal.dashboard') }}" class="flex items-center group overflow-hidden">
                <img src="{{ asset('assets/CreTechNavbarBisnis.svg') }}" alt="CreTech Portal Bisnis" class="h-14 w-auto object-contain max-w-[190px] group-hover:scale-105 transition-transform">
            </a>
